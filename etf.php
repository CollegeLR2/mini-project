...
<body>
    ...
    <div>
        ...
        <img src="etf-logo.png" style="width: 30%; margin: -2% 0 -5% 0" alt="Escape the Fate">
    </div>
    ...
    <div class="row" style="padding-left: 10%; padding-right: 10%;">
        ...
        <p>With a passionate following, Escape the Fate stands as a testament to the power of music in connecting people. Their ability to convey emotion through their music, combined with their electrifying live performances, positions Escape the Fate as a band that leaves an indelible mark on the hearts of their fans.</p>
    </div>
