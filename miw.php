...
<body>
    ...
    <div>
        ...
        <img src="miw-logo.png" style="width: 30%" alt="Motionless in White">
    </div>
    ...
    <div class="row" style="padding-left: 10%; padding-right: 10%;">
        ...
        <p>With a devoted global following, Motionless in White stands as a beacon of artistic expression within the realm of metal. Their ability to provoke thought and emotion through their music, combined with their electrifying live shows, positions Motionless in White as a band that transcends traditional genre boundaries.</p>
    </div>
